...
> Unit 1 Project - **Due by COB 3rd of DECEMBER**
...
| Solution Code | Sample solutions for all required sections | [Here](not-releases) |
...
Some of these problems are well known, so it may be possible to find complete solutions online. Students should see these questions as an opportunity to challenge themselves; looking up answers limits the potential growth that comes from practice and repetition of these skills. Coping solutions from the internets without quoting your source is frowned upon.
...
Your instructor will explain how to submit your assignment in the third session. This is done by:

- Forking a project repository to your GA GitHub profile
- Adding your solutions and pushing them to your fork
- Sending Hamish a link to your fork on Slack